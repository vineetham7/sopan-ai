      ...
      <footer className="about-footer">
        <div className="about-footer-inner">
          ...
          <div className="about-footer-meta">
            <span className="about-footer-name">
              <svg viewBox="0 0 16 16" width="14" height="14" fill="currentColor" aria-hidden="true">
                <path d="M8 8a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm0 1.5c-2.9 0-6 1.46-6 3.4V14a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-1.1c0-1.94-3.1-3.4-6-3.4Z" />
              </svg>
              Vineetha Muppala
            </span>
            <a
