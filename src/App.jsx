      ...
      <footer className="about-footer">
        <div className="about-footer-inner">
          ...
          <p className="about-footer-why">
            ...
            community) that empowers women professionals to learn and ship production-grade apps on real
            infrastructure, not just slides. This project applies that same philosophy directly: learning should be
            sustainable, hands-on, and genuinely accessible to everyone — not gated by cost or background.
          </p>
          <div className="about-footer-meta">
            <span>Vineetha Muppala</span>
            <a href="https://www.linkedin.com/in/vineetha-muppala-525133245/" target="_blank" rel="noreferrer">LinkedIn ↗</a>
            <a href="https://github.com/vineetham7/sopan-ai" target="_blank" rel="noreferrer">Source on GitHub ↗</a>
          </div>
        </div>
      </footer>
    </div>
